...
export const MalaysiaAnalysis: React.FC = () => {
  ...
  // Calculate the stats
  const appsWearablesStats = calculateAppsWearablesStats(myData);
  const socialEnvironmentStats = calculateSocialEnvironmentStats(myData);
